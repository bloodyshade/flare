    ...
    <div class="container flex flex-wrap items-center justify-center mt-2 py-16">
        <div class="w-full text-center">
            ...
            <div class="mt-8 space-x-2">
                <x-common.buttons.links.link title="Join!" color="blue"/>
                <x-common.buttons.links.link title="Releases" color="yellow" link="{{route('releases.list')}}"/>
                <x-common.buttons.links.link title="Help Section" link="{{route('info.page', [
                    'pageName' => 'home'
                ])}}" color="green"/>
            </div>
        </div>
